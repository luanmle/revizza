...
| GET | `/api/v1/decks/{id}/` | usuário | Detalhe de um deck (nome, tags, contagens de notas/assinantes/moderadores e `is_moderator` do usuário atual), sem e-mails da equipe | FR-006 |
