...
|---|---|---|---|---|
| POST | `/api/v1/accounts/register/` | público | Cria conta (e-mail/senha via Supabase Auth) + perfil; recebe `target_career`, `target_board`, `consent_marketing_emails`, `consent_research_data` opcionais | FR-001, FR-004, FR-005 |
| POST | `/api/v1/accounts/password-reset/` | público | Dispara e-mail de recuperação (delegado ao Supabase Auth) | FR-003 |
| GET | `/api/v1/accounts/me/` | usuário | Retorna perfil, preferências e consentimentos atuais | FR-002 |
